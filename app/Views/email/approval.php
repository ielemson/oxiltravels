...
<head>
    ...
    <!--<![endif]-->
	<title>Oxylglobal Travels and Tours</title>
	<!--[if gte mso 9]>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<th class="column-top" width="120" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="logo m-center img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://www.oxlyglobal.com/frontend/images/oxil-global.png" width="104" height="25" border="0" alt="" /></td>
																	</tr>
																</table>
															</th>
															...
															<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="text-top center" style="color:#999999; font-family:'Lato', Arial, sans-serif; font-size:14px; line-height:18px; min-width:auto !important; text-align:center;"><a href="<?=base_url('/')?>" target="_blank" class="link-blue" style="color:#0a2641; text-decoration:none;"><span class="link-blue" style="color:#0a2641; text-decoration:none;">Home</span></a> &nbsp; &nbsp; &nbsp; &nbsp; <a href="<?=base_url('about')?>" target="_blank" class="link-blue" style="color:#0a2641; text-decoration:none;"><span class="link-blue" style="color:#0a2641; text-decoration:none;">About</span></a> &nbsp; &nbsp; &nbsp; &nbsp; <a href="<?=base_url('contact')?>" target="_blank" class="link-blue" style="color:#0a2641; text-decoration:none;"><span class="link-blue" style="color:#0a2641; text-decoration:none;">Contact</span></a></td>
																	</tr>
																</table>
															</th>
															<th style="padding-bottom: 20px !important; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;" class="column" width="1"></th>
											...
											<tr>
												<td class="p30-20" style="padding: 80px 50px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															<td class="text white center" style="padding-bottom: 25px; font-family:'Lato', Arial, sans-serif; font-size:16px; line-height:28px; min-width:auto !important; color:#ffffff; text-align:center;">Payment for <?=$program;?> has been approved.</td>
														</tr>
														<tr>
															<td align="center">
																<table border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="text-button" style="color:#ffffff; font-family:'Lato', Arial, sans-serif; font-size:16px; line-height:20px; text-align:center; text-transform:uppercase; font-weight:bold; min-width:auto !important; padding:12px 22px; background:#0a2641; border-radius:4px;"><a href="<?=base_url('user/dashboard')?>" target="_blank" class="link-white" style="color:#ffffff; text-decoration:none;"><span class="link-white" style="color:#ffffff; text-decoration:none;">VIEW PROGRAMS</span></a></td>
																	</tr>
																</table>
															</td>
														</tr>
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<th class="column" width="170" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																			<table width="100%" border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					<td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://www.oxlyglobal.com/frontend/images/oxil-global-white.png" width="104" height="30" border="0" alt="" /></td>
																				</tr>
																			</table>
																		</th>
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<th class="column-top" width="370" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
																			<table width="100%" border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					<td class="text-footer m-center" style="color:#666666; font-family:'Lato', Arial, sans-serif; font-size:12px; line-height:26px; text-align:left; min-width:auto !important;">OxylGlobal  - Travels & Tours <br />139 Obafemi Awolowo Way, Ikeja Lagos, Nigeria</td>
																				</tr>
																			</table>
																		</th>
