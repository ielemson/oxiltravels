...
<head>
    ...
    <link href="<?=base_url("dashboard/assets/vendor/fontawesome/css/fontawesome.min.css")?>" rel="stylesheet">
    <link href="<?=base_url("dashboard/assets/vendor/fontawesome/css/solid.min.css")?>" rel="stylesheet">
    <link href="<?=base_url("dashboard/assets/vendor/fontawesome/css/brands.min.css")?>" rel="stylesheet">
    ...
    <link href="<?=base_url("dashboard/assets/vendor/flagiconcss/css/flag-icon.min.css")?>" rel="stylesheet">
    <link href="<?=base_url("dashboard/assets/vendor/datatables/datatables.min.css")?>" rel="stylesheet">
...
<body>
    ...
    <script src="<?=base_url("dashboard/assets/vendor/jquery/jquery.min.js")?>"></script>
    <script src="<?=base_url("dashboard/assets/vendor/bootstrap/js/bootstrap.bundle.min.js")?>"></script>
    <script src="<?=base_url("dashboard/assets/vendor/chartsjs/Chart.min.js")?>"></script>
    ...
    <script src="<?=base_url("dashboard/assets/vendor/datatables/datatables.min.js")?>"></script>
