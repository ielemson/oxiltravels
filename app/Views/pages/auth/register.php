...
<div class="card-top-panel">
              <div class="card-top-panel-left">
                <h4 class="card-title card-title-login">Register</h4>
              </div>

            </div>
        <form id="registerForm" action="<?=base_url('auth/register')?>" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
        <?= csrf_field() ?>
