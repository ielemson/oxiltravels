...
<a href="<?= base_url('admin/post/index') ?>"><i class="fas fa-exit"></i>Logout</a>
        ...
        <div class="dropdown-divider"></div>
        <li>
            <a href="#partnermenu" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle no-caret-down"><i class="fas fa-copy"></i> Partner</a>
            <ul class="collapse list-unstyled" id="partnermenu">
               
                <li>
                    <a href="<?= base_url('admin/partner') ?>"><i class="fas fa-file"></i>Partner</a>
                </li>
