                        ...
                        action: function() {
                            $.confirm({
                                ...
                                content: '' +
                                    ...
                                    '<textarea rows="1" placeholder="Your address" name="address" class="address form-control" required></textarea/>' +
                                    '</div>' +
                                    '</div>' +
                                    '<div class="col-md-6">' +
                                    '<div class="form-group">' +
                                    ...
                                    '<textarea rows="1" placeholder="Next of kin address" name="nexofkin_address" class="nexofkin_address form-control" required></textarea/>' +
                                    '</div>' +
                                    '</div>' +
                                    '</div>' +
                                    '</form>',
