            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <p class="box-contacts-link"><a href="tel_3a#">+44 763 749 109</a></p>
                  <p class="box-contacts-link"><a href="tel_3a#">+234 813 730 1330</a></p>
                </div>
              </article>
            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="#">139 Obafemi Awolowo Way, Ikeja Lagos</a></p>
                </div>
              </article>
            </div>
            <div class="col-sm-8 col-md-6 col-lg-4">
